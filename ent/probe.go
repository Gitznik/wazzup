...
// to the Probe fields.
func (_m *Probe) assignValues(columns []string, values []any) error {
...
func (_m *Probe) Value(name string) (ent.Value, error) {
